<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Quantites.aspx.cs" Inherits="Guce.Orbus.Analytics.Quantites" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtNomBeneficiare.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Quantites.aspx/ChargerListeBeneficiaire",
            ...
            $("#<%=txtCodeProduit.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Quantites.aspx/ChargerListeProduit",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
            ...
            $("#<%=txtCodePays.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Quantites.aspx/ChargerListePays",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row" id="resultatQuantites" runat="server">
                <div class="col-md-12">
                    <div class="card">
                        <br />
                        <div class="card-body">
