<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StatsGlobalesClient.aspx.cs" Inherits="Guce.Orbus.Analytics.StatsGlobalesClient" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtCodeProduit.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "StatsGlobalesClient.aspx/ChargerListeProduit",
