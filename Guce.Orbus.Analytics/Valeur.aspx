<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Valeur.aspx.cs" Inherits="Guce.Orbus.Analytics.Valeur" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtNomBeneficiare.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Valeur.aspx/ChargerListeBeneficiaire",
            ...
            $.ajax({
                type: "POST",
                url: "Valeur.aspx/ChargerListeProduit",
                data: JSON.stringify(obj),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        $("#<%=txtCodePays.ClientID %>").keyup(function () {
            ...
            $.ajax({
                type: "POST",
                url: "Valeur.aspx/ChargerListePays",
                data: JSON.stringify(obj),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-row">
                                        <h4 class="card-title f1"><b>Total Transactions : &nbsp;</b></h4>
                                        <%--<asp:Image ImageUrl="~/Images/transactions.jpg" class="col-form-label" runat="server" Height="25px" Width="21px" ToolTip="Total Transactions" />&nbsp;--%>
