<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Guce.Orbus.Analytics.Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtNomBeneficiare.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Details.aspx/ChargerListeBeneficiaire",
            ...
            $("#<%=txtCodeProduit.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Details.aspx/ChargerListeProduit",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
            ...
            $("#<%=txtCodePays.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Details.aspx/ChargerListePays",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header  card-header-icon">
                            ...
                            <h3 class="card-title f1" style="text-align:center"><b>Statistiques par Détails</b></h3>
            ...
            <div class="row" id="resultatDetails" runat="server">
                <div class="col-md-12">
                    <div class="card">
                        <br />
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-row">
                                            <label class="col-form-label">Total Transactions : &nbsp;</label>
                            ...
                            <br />
                            <div class="table-responsive">
                                <asp:GridView ID="DetailsListeGridView" runat="server" CssClass="table" ShowHeader="True" Style="border-collapse: collapse;" CellSpacing="0" BorderStyle="None" GridLines="None"
                                    EmptyDataText="Aucune information trouvée ." Width="100%" UseAccessibleHeader="true"
                                    PagerSettings-Position="Bottom"
                                    OnSelectedIndexChanged="DetailsListeGridView_SelectedIndexChanged"
                                    OnPageIndexChanging="DetailsListeGridView_PageIndexChanging"
