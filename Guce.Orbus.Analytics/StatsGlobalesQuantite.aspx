<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StatsGlobalesQuantite.aspx.cs" Inherits="Guce.Orbus.Analytics.StatsGlobalesQuantite"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtNomBeneficiare.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "StatsGlobalesQuantite.aspx/ChargerListeBeneficiaire",
            ...
            $("#<%=txtCodeProduit.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "StatsGlobalesQuantite.aspx/ChargerListeProduit",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
            ...
            $("#<%=txtCodePays.ClientID %>").keyup(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "StatsGlobalesQuantite.aspx/ChargerListePays",
                    data: JSON.stringify(obj),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header  card-header-icon">
                            ...
                            <h3 class="card-title f1" style="text-align:center"><b>Statistiques Globales par Quantité</b></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Le produit est obligatoire." ControlToValidate="txtProduit" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
            ...
            <div class="row" id="resultatStatsGlobalesQuantite" runat="server">
                <div class="col-md-12">
                    <div class="card">
                        <br />
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                    ...
                                    <%--<div class="col">
                                        <div class="form-row">
                                            <label class="col-form-label">Part de marché ORBUS : &nbsp;</label>
