...
{
    public partial class StatsGlobalesQuantite : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            resultatStatsGlobalesQuantite.Visible = false;
        ...
        private void ChargerDonnees(string sortExpression = null)
        {
            ...
            if (numIncsriptionClient > 0)
            {
                ...
                {
                    strPartages = str + " inner join OPERATEUR op on do.TRANSITAIRE = op.IDTPSOPERATEUR " +
                                  " WHERE op.NUMEROINSCRIPTIONABONNE = " + numIncsriptionClient +
            ...
            if (verifChamps)
            {
                ...
                if (datePar == "1")
                {
                    if (devise == "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE, co.UNITEMESURE , co.QUANTITEMESURE, DATENAME(MONTH, do.DATEDOSSIERTPS),DATEPART(MONTH,datedossiertps),DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (paysProvenance != "" && devise == "-1" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION ,fa.PAYSPROVENANCE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE , co.QUANTITEMESURE, DATENAME(MONTH, do.DATEDOSSIERTPS),DATEPART(MONTH,datedossiertps),DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (paysOrigine != "" && devise == "-1" && paysProvenance == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , co.PAYSORIGINE ,  co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE , co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS),DATEPART(MONTH,datedossiertps),DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (beneficiaire != "" && devise == "-1" && paysOrigine == "" && paysProvenance == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , do.NOMOURAISONSOCIALEBENEFICIAIRE,  co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE , co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS),DATEPART(MONTH,datedossiertps),DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.PAYSORIGINE ,  co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire != "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  do.NOMOURAISONSOCIALEBENEFICIAIRE, co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE, co.PAYSORIGINE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE , co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && beneficiaire != "" && paysOrigine == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE, do.NOMOURAISONSOCIALEBENEFICIAIRE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysOrigine != "" && beneficiaire != "" && paysProvenance == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysProvenance != "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.PAYSPROVENANCE, co.PAYSORIGINE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysProvenance != "" && beneficiaire != "" && paysOrigine == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.PAYSPROVENANCE, do.NOMOURAISONSOCIALEBENEFICIAIRE, co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysOrigine != "" && beneficiaire != "" && paysProvenance == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysOrigine != "" && beneficiaire != "" && paysProvenance != "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE , co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATENAME(MONTH, do.DATEDOSSIERTPS), DATEPART(MONTH,datedossiertps), DATENAME(YEAR,do.DATEDOSSIERTPS) " +
                ...
                else
                {
                    if (devise == "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (paysProvenance != "" && devise == "-1" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , fa.PAYSPROVENANCE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (paysOrigine != "" && devise == "-1" && paysProvenance == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY do.IMPORTATIONOUEXPORTATION , co.PAYSORIGINE , co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE ,co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && paysOrigine == "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE ,co.UNITEMESURE ,  co.QUANTITEMESURE , DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.PAYSORIGINE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire != "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE , DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE, co.PAYSORIGINE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE ,co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysProvenance != "" && beneficiaire != "" && paysOrigine == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE,do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise != "-1" && paysOrigine != "" && beneficiaire != "" && paysProvenance == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE, co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysProvenance != "" && paysOrigine != "" && beneficiaire == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.PAYSPROVENANCE, co.PAYSORIGINE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysProvenance != "" && beneficiaire != "" && paysOrigine == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.PAYSPROVENANCE, do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    if (devise == "-1" && paysOrigine != "" && beneficiaire != "" && paysProvenance == "")
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                    ...
                    {
                        strGroup = " GROUP BY  do.IMPORTATIONOUEXPORTATION , fa.CODEDEVISE ,  fa.PAYSPROVENANCE, co.PAYSORIGINE, do.NOMOURAISONSOCIALEBENEFICIAIRE ,co.NUMEROTARIFDOUANE , ta.LIBELLETARIFDOUANE , co.UNITEMESURE ,  co.QUANTITEMESURE ,  DATEPART(YEAR,datedossiertps) , DATENAME(YEAR, do.DATEDOSSIERTPS) " +
                ...
                try
                {
                    ...
                    if (devise == "-1" && paysProvenance == "" && paysOrigine == "" && beneficiaire == "")
                    {
                        using (cmd1 = new SqlCommand(str, con))
                        {
                            ...
                            {
                                resultatStatsGlobalesQuantite.Visible = true;
                    ...
                    strGlobalOrbus = " SELECT SUM(co.QUANTITEMESURE) [Total] " +
                                  " FROM FACTURE  fa inner join DOSSIERTPS do on do.NUMERODOSSIERTPS = fa.NUMERODOSSIERTPS" +
                                  " inner join CONTENIR co on co.NUMERODOSSIERTPS=do.NUMERODOSSIERTPS " +
                                  " inner join TARIFDOUANE ta on co.NUMEROTARIFDOUANE=ta.NUMEROTARIFDOUANE " +
                    ...
                    if (strInterne != "")
                    {
                        if (numIncsriptionClient > 0)
                        {
                            ...
                            {
                                strGlobalOrbusPoleOperateur = " SELECT SUM(co.QUANTITEMESURE) [Total] " +
                                      " FROM FACTURE  fa inner join DOSSIERTPS do on do.NUMERODOSSIERTPS = fa.NUMERODOSSIERTPS" +
                                      " inner join CONTENIR co on co.NUMERODOSSIERTPS=do.NUMERODOSSIERTPS " +
                                      " inner join TARIFDOUANE ta on co.NUMEROTARIFDOUANE=ta.NUMEROTARIFDOUANE " +
                ...
                ////            if (sqlReader.GetValue(0).ToString() != null && sqlReader.GetValue(0).ToString() != "" && sqlReader.GetValue(0).ToString() != "0")
                ////            {
                ////                decimal.Parse(sqlReader.GetValue(0).ToString());
